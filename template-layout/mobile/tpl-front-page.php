<div id="mainContainer">
    ...
    <div id="sectionTwo">
        <div class="container">
            <div class="row no-gutters">
                <div id="textContent" class="col-12">
    ...
    <div id="sectionFive">
        <div class="container">
            ...
            <div class="d-flex flex-column justify-content-center section-content">
                <div class="p-2"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_24.jpg" class="mx-auto d-block"></a></div>
                <div class="p-2"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_26.jpg" class="mx-auto d-block"></a></div>
                <div class="p-2"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_28.jpg" class="mx-auto d-block"></a></div>                  
            </div>
    ...
    <div id="sectionSix">
        <div class="container">
            ...
            <div class="d-flex justify-content-center section-content">
                <div class="p-2 item"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_34.jpg"></a></div>
                <div class="p-2 item"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_37.jpg"></a></div>
                <div class="p-2 item"><a href="#"><img src="<?php bloginfo('template_directory') ?>/assets/images/theme01_mockup_40.jpg"></a></div>  
            </div>
        </div>
    </div>
    <div id="sectionSeven">
